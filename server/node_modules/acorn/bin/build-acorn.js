...
browserify({standalone: "acorn"})
  ...
  .transform(babelify)
  .require("./src/AnalysisDetail.js", {entry: true})
  .bundle()
...
function acornShimPrepare(file) {
  ...
  if (file == path.resolve(__dirname, "../src/AnalysisDetail.js")) {
    var sent = false
...
browserify({standalone: "acorn.loose"})
  ...
  .transform(babelify)
  .require("./src/loose/AnalysisDetail.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
...
browserify({standalone: "acorn.walk"})
  ...
  .transform(acornShimPrepare)
  .transform(babelify)
  .require("./src/walk/AnalysisDetail.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
  .pipe(acornShimComplete())
